...
class Ui_Controller(object):
    def setupUi(self, Controller):
        ...
        self.QSliderCutXLeft = QSlider(Controller)
        self.QSliderCutXLeft.setObjectName(u"QSliderCutXLeft")
        self.QSliderCutXLeft.setGeometry(QRect(100, 350, 163, 15))
        self.QSliderCutXLeft.setMaximum(100)
        self.QSliderCutXLeft.setValue(50)
        self.QSliderCutXLeft.setOrientation(Qt.Horizontal)
        self.label_17 = QLabel(Controller)
        self.label_17.setObjectName(u"label_17")
        self.label_17.setGeometry(QRect(10, 350, 81, 16))
        self.QSliderCutXRight = QSlider(Controller)
        self.QSliderCutXRight.setObjectName(u"QSliderCutXRight")
        self.QSliderCutXRight.setGeometry(QRect(100, 380, 163, 15))
        self.QSliderCutXRight.setMaximum(100)
        self.QSliderCutXRight.setValue(50)
        self.QSliderCutXRight.setOrientation(Qt.Horizontal)
        self.label_18 = QLabel(Controller)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(10, 380, 81, 16))
        self.QSliderCutYRight = QSlider(Controller)
        self.QSliderCutYRight.setObjectName(u"QSliderCutYRight")
        self.QSliderCutYRight.setGeometry(QRect(100, 440, 163, 15))
        self.QSliderCutYRight.setMaximum(100)
        self.QSliderCutYRight.setValue(50)
        self.QSliderCutYRight.setOrientation(Qt.Horizontal)
        self.label_19 = QLabel(Controller)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(10, 410, 81, 16))
        self.QSliderCutYLeft = QSlider(Controller)
        self.QSliderCutYLeft.setObjectName(u"QSliderCutYLeft")
        self.QSliderCutYLeft.setGeometry(QRect(100, 410, 163, 15))
        self.QSliderCutYLeft.setMaximum(100)
        self.QSliderCutYLeft.setValue(50)
        self.QSliderCutYLeft.setOrientation(Qt.Horizontal)
        self.label_20 = QLabel(Controller)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setGeometry(QRect(10, 440, 81, 16))
    ...
    def retranslateUi(self, Controller):
        ...
        self.label_17.setText(QCoreApplication.translate("Controller", u"Cut_x_left", None))
        self.label_18.setText(QCoreApplication.translate("Controller", u"Cut_y_right", None))
        self.label_19.setText(QCoreApplication.translate("Controller", u"Cut_x_top", None))
        self.label_20.setText(QCoreApplication.translate("Controller", u"Cut_y_bottom", None))
    # retranslateUi
